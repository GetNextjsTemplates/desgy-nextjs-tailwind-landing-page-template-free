...
const FAQ = () => {
  return (
    <section id="FAQ" className="relative py-1 bg-cover bg-center overflow-hidde dark:bg-darkmode">
      <div className="container mx-auto max-w-(--breakpoint-xl) px-4">
        <div className="relative rounded-2xl py-24 bg-faqBg bg-no-repeat bg-cover bg-primary">
          ...
          <h2 className="text-6xl font-semibold text-center text-white xl:mx-72 lg:mx-72">
