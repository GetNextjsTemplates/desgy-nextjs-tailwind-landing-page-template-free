...
const Hero = () => {
  ...
  return (
    <section className='relative md:pt-40 md:pb-28 overflow-hidden z-1'>
      <div className='container mx-auto pt-30 max-w-(--breakpoint-xl) px-4'>
        <div className='grid grid-cols-12 justify-center items-center'>
          <div className='col-span-12 xl:col-span-5 lg:col-span-6 md:col-span-12 sm:col-span-12'>
            ...
            <h1 className='text-80 font-bold w-full md:mb-6'>
